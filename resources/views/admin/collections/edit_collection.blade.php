...
@section('content')
    <div class="gc_row">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.update.collection') }}" method="post" enctype="multipart/form-data"
                    class="row g-3">
                    @csrf
                    <div class="col-md-6">
                        <label for="Name" class="form-label">Collection Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="name" id="Name"
                            value="{{ $collection->name }}" placeholder="" autofocus />
                        @if ($errors->has('name'))
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="slug" id="Slug"
                            value="{{ $collection->slug }}" placeholder="">
                        @if ($errors->has('slug'))
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" name="order_no" id="orderNo"
                            value="{{ $collection->order_no }}" placeholder="" />
                    ...
                    <div class="row upload mt-3 @if ($collection->image_type != 1) d-none @endif">
                        ...
                        <div class="col-md-4">
                            @if (!blank($collection->image))
                                <img src="{{ url('/') }}/collection/{{ $collection->image }}"
                                    class="product_preview upload w-50" id="product_image">
                    ...
                    <hr>
                    {{-- Multiple Banner Image Upload Section --}}
                    <div class="row upload mt-3 @if ($collection->image_type != 1) d-none @endif">
                        @php
                            $bannerTypes = [
                                'ring_banner' => 'Ring Banner',
                                'necklace_banner' => 'Necklace Banner',
                                'ear_banner' => 'Ear Jewelry Banner',
                                'bracelet_banner' => 'Bracelet Banner',
                            ];
                        @endphp

                        @foreach ($bannerTypes as $key => $label)
                            ...
                            <div class="col-md-4 mt-3">
                                @php
                                    $imagePath = $collection->$key ?? '';
                                @endphp
                                <div class="row">
                                    <div class="col-md-4">
                                        <img id="preview-{{ $key }}"
                                            src="{{ !blank($imagePath) ? url('/collection/' . $imagePath) : url('/assets/Images/upload.png') }}"
                                            width="80px" alt="">
                                        <input type="hidden" name="uploaded_{{ $key }}"
                                            value="{{ $imagePath }}">
                                    </div>
                                    <div class="col-md-8">
                                        @if (!blank($imagePath))
                                            <a href="javascript:void(0);" class="text-danger delete-banner-img"
                    ...
                    {{-- <div class="col-md-12 mt-3">
                        <label for="default_banner" class="fw-bold text-decoration-underline">Default Banner Image</label>
                    </div>
                    <div class="col-md-8">
                        <input type="file" class="form-control" name="default_banner" id="default_banner" />
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-3">
                                <img id="preview-default_banner"
                                    src="{{ !blank($collection->default_banner) ? url('/collection/' . $collection->default_banner) : url('/assets/Images/upload.png') }}"
                                    width="80px" alt="">
                                <input type="hidden" name="uploaded_default_banner"
                                    value="{{ $collection->default_banner }}">
                            </div>
                            <div class="col-md-9">
                                @if (!blank($collection->default_banner))
                                    <a href="javascript:void(0);" class="text-danger delete-banner-img"
                                        data-key="default_banner">Delete</a>
                                @endif
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <hr>
                    <div class="col-md-12">
                        <span for="BannerImages" class="fw-bold text-decoration-underline">Sub-Menu Images</span>
                    </div>
                    <div class="col-md-12 imagelink @if ($collection->image_type != 2) d-none @endif">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="image_link" id="ImageLink"
                                value="{{ $collection->image }}" placeholder="" />
                            @if ($errors->has('image'))
                                <span class="text-danger">{{ $errors->first('image') }}</span>
                            @endif
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <img id="uploaded-menu-image-preview"
                                    src="{{ url('/') }}/categories/{{ $collection->menu_image }}" width="80px"
                                    alt="">
                                <input type="hidden" name="hidden_menu_image" class="hidden_menu_image"
                                    value="{{ $collection->menu_image }}">
                            </div>
                            <div class="col-md-9">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-3">
                                <img id="uploaded-ring-image-preview"
                                    src="{{ url('/') }}/ring_image/{{ $collection->ring_image }}" width="80px"
                                    alt="">
                                <input type="hidden" name="hidden_ring_image" class="hidden_ring_image"
                                    value="{{ $collection->ring_image }}">
                            </div>
                            <div class="col-md-9">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-3">
                                <img id="uploaded-necklace-image-preview"
                                    src="{{ url('/') }}/necklace_image/{{ $collection->necklace_image }}"
                                    width="80px" alt="">
                                <input type="hidden" name="hidden_necklace_image" class="hidden_necklace_image"
                                    value="{{ $collection->necklace_image }}">
                            </div>
                            <div class="col-md-9">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-3">
                                <img id="uploaded-ear_jewelry-image-preview"
                                    src="{{ url('/') }}/ear_jewelry_mage/{{ $collection->ear_jewelry_mage }}"
                                    width="80px" alt="">
                                <input type="hidden" name="hidden_ear_jewelry_image" class="hidden_ear_jewelry_image"
                                    value="{{ $collection->ear_jewelry_mage }}">
                            </div>
                            <div class="col-md-9">
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-3">
                                <img id="uploaded-bracelets-image-preview"
                                    src="{{ url('/') }}/bracelets_image/{{ $collection->bracelets_image }}"
                                    width="80px" alt="">
                                <input type="hidden" name="hidden_bracelets_image" class="hidden_bracelets_image"
                                    value="{{ $collection->bracelets_image }}">
                            </div>
                            <div class="col-md-9">
...
@section('script')
    <script>
        ...
        // Dynamic preview and delete for multiple banner images
        ['ring_banner', 'necklace_banner', 'ear_banner', 'bracelet_banner'].forEach(function(key) {
            $('#' + key).change(function() {
                let reader = new FileReader();
                reader.onload = (e) => {
                ...
                reader.readAsDataURL(this.files[0]);
                $('.delete-banner-img[data-key="' + key + '"]').show();
            });

            $(document).on('click', '.delete-banner-img[data-key="' + key + '"]', function() {
                $('#preview-' + key).attr('src', '{{ url('/assets/Images/upload.png') }}');
                $('input[name="uploaded_' + key + '"]').val('');
                $('#' + key).val('');
                $(this).hide();
            });
        });
