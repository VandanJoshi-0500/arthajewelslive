...
<section class="product_listing product_listing_outer_div">
    ...
    <div class="container-fluid p-0 product_listing_innerbanner" >
        <img src="{{ URL::asset('assets/images/shop/shop-banner03.jpg') }}" class="img-fluid" alt="...">
    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col_product_listing product_listing_outer">
                                    ...
                                    <a href="{{route('product.details',$product->sku)}}" class=" text-center">
                                            ...
                                            <div class="product_listing_box">
                                                ...
                                                <h6>€ @if(isset($product->price)){{$product->getPriceForCustomer()}} @else {{$product->special_price}} @endif</h6>    
    ...
    function record(page){
        ...
        var chk = [];
            ...
            $.ajax({
                ...
                type: 'GET',
                url: '/projects/arthajewelslive/search/'+slug+'?page='+page,
