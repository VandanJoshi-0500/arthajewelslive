...
@section('content')
    ...
    <section class="product_listing product_listing_outer_div">
        ...
        <div class="container-fluid p-0 product_listing_innerbanner"
            style="background-image: url('{{ URL::asset('assets/images/shop/shop-banner03.jpg') }}'); background-size: cover; background-position: center;">
                            ...
                            <div class="my-3">
                                ...
                                @foreach ($pro_categories as $pro_cat)
                                    <div class="collection-checkbox">
                                        ...
                                        <input type="checkbox" id="chk-{{ $pro_cat->id }}" name="chk[]" class="chk"
                                            value="{{ $pro_cat->id }}">
                            ...
                            <div class="my-3">
                                ...
                                @foreach ($pro_collections as $pro_coll)
                                    <div class="collection-checkbox">
                                        ...
                                        <input type="checkbox" id="coll-{{ $pro_coll->id }}" name="coll[]" class="chk"
                                            value="{{ $pro_coll->id }}">
    ...
    <script>
        ...
        function record(page) {
            ...
            $.ajax({
                ...
                url: '/projects/arthajewelslive/shop/' + '?page=' + page,
