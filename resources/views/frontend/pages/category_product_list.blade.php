    ...
    @section('content')
        ...
        <section class="product_listing product_listing_outer_div">
            ...
            <!--<div class="container-fluid p-0 product_listing_innerbanner testt" style="background-image: url('{{ substr($collection->image, 0, 7) == 'http://' || substr($collection->image, 0, 7) == 'https://' ? $collection->image : URL::asset('collection/' . $collection->image) }}'); background-size: cover; background-position: center;">

                    

                    </div>-->
            <div class="container-fluid p-0 product_listing_innerbanner">
                <img src="{{ substr($collection->image, 0, 7) == 'http://' || substr($collection->image, 0, 7) == 'https://' ? $collection->image : URL::asset('collection/' . $collection->image) }}"
                    class="img-fluid" alt="...">
            </div>
                                            ...
                                            <div class="product_listing_inner">
                                                ...
                                                <a href="{{ route('product.details', $product->sku) }}"
                                                    ...
                                                    <div class="product_listing_box">
                                                        ...
                                                        <h6>€ @if (isset($product->price))
                                                                {{ $product->getPriceForCustomer() }}
                                                            @else
        ...
        <script>
            ...
            function record(page) {
                ...
                $.ajax({
                    ...
                    url: '/projects/arthajewelslive/category/' + slug + "/" + id + '?page=' + page,
            ...
            $(document).on('change', '#per_page', function() {
                ...
                let above_price = $('#price_above').prop('checked') ? 1 : 0;
                ...
                $.ajax({
                    type: 'GET',
                    url: `/projects/arthajewelslive/category/${slug}/${id}`,
                    // url: '/projects/arthajewelslive/category/'+slug+"/"+id+'?page='+page,
                    data: {
                        "_token": "{{ csrf_token() }}",
                        sort_by: selection,
                    ...
                    error: function(data) {
                        console.log("Error loading filtered products.");
                    }
                });
            });
