...
@section('content')
    ...
    <section class="product_listing product_listing_outer_div">
        ...
        <div class="container-fluid p-0 product_listing_innerbanner test"
            style="background-image: url('{{ URL::asset('public/assets/images/shop/shop-banner03.jpg') }}'); background-size: cover; background-position: center;">
