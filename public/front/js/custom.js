...
document.addEventListener('DOMContentLoaded', function () {
    const searchToggle = document.getElementById('searchToggle1');
    const searchBox = document.getElementById('search-box1');
    const searchClose = document.getElementById('searchClose1');
...
// this is for sub-dropdown under dropdown
...
//      // Reset to first tab and its content
//     var $firstTab = $('#pills-tab a').first();
//     var target = $firstTab.data('reference');

//     // Remove all active states
//     $('#pills-tab a, #pills-tab li').removeClass('active');
//     $('#pills-tabContent .tab-pane').removeClass('show active');

//     // Add active to first tab and its content
//     $firstTab.addClass('active');
//     $firstTab.closest('li').addClass('active');
//     $('#pills-tabContent ' + target).addClass('show active');
...
function toggleDropdown(e) {
  ...
  setTimeout(function () {
    ...
    // Only reset if NO tab is active
    if ($('#pills-tab a.active').length === 0) {
      var $firstTab = $('#pills-tab a').first();
      var target = $firstTab.data('reference');
    ...
    jQuery(document).ready(function ($) {
      ...
      $('#pills-tab[data-mouse="hover"] a').hover(function(){
        ...
        var target = $(this).data('reference');  // Get the tab content reference from the data-reference attribute
         ...
         // Remove active from all anchors and their parent <li>
