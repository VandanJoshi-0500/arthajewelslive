...
class WishlistController extends Controller
{
    ...
    public function Wishlist(Request $request){
        if(Auth::user()){
            ...
            $page = 'my_wishlist';
            $wishlists = Wishlist::where('user_id',$user_id)->whereHas('product')->get();
    ...
    public function WishlistDetails(Request $request, $name = null)
    {
        ...
        // Fetch wishlist with related items and products
        $wishlist = WishlistOrder::where('name', $name)
                                ->where('user_id', $user_id) // Ensure the wishlist belongs to the user
