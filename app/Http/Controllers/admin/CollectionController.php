...
class CollectionController extends Controller
{
    ...
    public function addCollectionData(Request $request){
        ...
        if($request->has('ring_banner_image') && $request->file('ring_banner_image') != null){
            $ring_banner_image = $request->file('ring_banner_image');
            // $destinationPath2 = public_path('ring_banner_image/');
            $destinationPath2 = 'ring_banner_image/';
            $rand2=rand(1,100);
            $docImage2 = date('YmdHis').$rand2. "." . $ring_banner_image->getClientOriginalExtension();
            $ring_banner_image->move($destinationPath2, $docImage2);
            $collection->ring_banner_image = $docImage2;
        }
        ...
        if($request->has('necklace_image') && $request->file('necklace_image') != null){
            ...
            $destinationPath3 = 'necklace_image/';
            $rand3=rand(1,100);
        ...
        if($request->has('ear_jewelry_mage') && $request->file('ear_jewelry_mage') != null){
            ...
            $destinationPath4 = 'ear_jewelry_mage/';
            $rand4=rand(1,100);
        ...
        if($request->has('bracelets_image') && $request->file('bracelets_image') != null){
            ...
            $destinationPath5 = 'bracelets_image/';
            $rand5=rand(1,100);
